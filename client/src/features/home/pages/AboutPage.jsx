      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white">Comprehensive Material</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white">Smart Learning</h3>
              <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white">Expert Community</h3>
              <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
