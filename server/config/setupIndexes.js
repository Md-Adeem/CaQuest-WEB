...
const setupIndexes = async () => {
  try {
    ...
    // Question indexes
    await Question.collection.createIndex({ chapter: 1, difficulty: 1, isActive: 1 });
    ...
    // Progress indexes
    await Progress.collection.createIndex({ user: 1, question: 1 }, { unique: true });
    ...
    // Bookmark indexes
    await Bookmark.collection.createIndex({ user: 1, question: 1 }, { unique: true });
