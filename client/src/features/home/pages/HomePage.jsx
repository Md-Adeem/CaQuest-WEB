...
import { 
  HiAcademicCap, HiBookOpen, HiShieldCheck, 
  HiLightningBolt, HiUsers, HiStar,
  ...
  const features = [
    {
      ...
      description: 'Structured question banks organized by chapter for systematic preparation',
      color: 'bg-blue-100 text-blue-600',
    },
    {
      icon: <HiAcademicCap className="w-8 h-8" />,
      title: 'All CA Levels',
      description: 'Complete coverage for Foundation, Intermediate, and Final levels',
      color: 'bg-purple-100 text-purple-600',
    },
    {
      icon: <HiLightningBolt className="w-8 h-8" />,
      title: 'Instant Feedback',
      description: 'Get immediate answers with detailed explanations for every question',
      color: 'bg-amber-100 text-amber-600',
    },
    {
      icon: <HiShieldCheck className="w-8 h-8" />,
      title: 'Expert Curated',
      description: 'Questions crafted by experienced CA professionals and educators',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium">Trusted by 5000+ CA Students</span>
            </div>
